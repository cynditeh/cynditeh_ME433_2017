    ...
    switch (appData.state) {
        ...
        case APP_STATE_SCHEDULE_READ:
            ...
            if (appData.isReadComplete == true) {
                ...
                if (gotRx == 1){
                    if (rxVal >=0 && rxVal< 50 ){//turn left
                        LATAbits.LATA1 = 1; // direction
                        OC1RS = (50-rxVal)*20; // velocity, 50%
                        LATBbits.LATB3 = 1; // direction
                        OC4RS = (50-rxVal)*20; // velocity, 50%
                    }
                    else if (rxVal==50){//forward full speed
                        LATAbits.LATA1 = 1; // direction
                        OC1RS = 1200; // velocity, 100%
                        LATBbits.LATB3 = 0; // direction
                        OC4RS = 1200; // velocity, 100%
                    }
                    else if (rxVal>50 && rxVal<=100){//turn right
                        LATAbits.LATA1 = 0; // direction
                        OC1RS = (rxVal-50)*20; // velocity, 50%
                        LATBbits.LATB3 = 0; // direction
                        OC4RS = (rxVal-50)*20; // velocity, 50%
                    }
                    else {
                        LATAbits.LATA1 = 1; // direction
                        OC1RS = 0; // velocity, 50%
